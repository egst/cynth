...
namespace cynth::syn::array_nodes {
    ...
    struct ElementsResult {
        ...
        inline bool comptime () const {
            return static_cast<Integral>(compValues.size()) == arraySize;
        }
    };
    ...
    namespace detail::misc {
        ...
        SingleExpressionProcessingResult processStaticSubscript (Integral, sem::ResolvedValue const &);
    ...
    ***/
    constexpr auto processStaticSubscript (Integral index) {
