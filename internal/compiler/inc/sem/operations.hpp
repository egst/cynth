...
namespace cynth::sem {
    ...
    namespace comptime {
        ...
        // Note: There's some MSVC bug that doesn't allow constexpr here.
        /*constexpr*/ inline auto div   = esl::overload(implementation::idiv, [] (Floating a, Floating b) { return a / b; });
        /*constexpr*/ inline auto mod   = esl::overload(implementation::imod, implementation::fmod);
    ...
    namespace runtime {
        ...
        // Note: There's some MSVC bug that doesn't allow constexpr here.
        /*constexpr*/ inline auto plus  = detail::numericTypeParam(implementation::id);
        /*constexpr*/ inline auto minus = detail::numericTypeParam(c::negate);
        /*constexpr*/ inline auto add   = detail::numericTypeParam(c::add);
        /*constexpr*/ inline auto sub   = detail::numericTypeParam(c::sub);
        /*constexpr*/ inline auto mul   = detail::numericTypeParam(c::mul);
        /*constexpr*/ inline auto div   = esl::overload(detail::typeParam<type::Int>(implementation::idiv), detail::typeParam<type::Float>(c::div));
        /*constexpr*/ inline auto mod   = esl::overload(detail::typeParam<type::Int>(implementation::imod), detail::typeParam<type::Float>(implementation::fmod));
        /*constexpr*/ inline auto pow   = detail::typeParam<type::Float>(implementation::fpow);
        /*constexpr*/ inline auto lt    = detail::simpleTypeParam(c::lt);
        /*constexpr*/ inline auto gt    = detail::simpleTypeParam(c::gt);
        /*constexpr*/ inline auto le    = detail::simpleTypeParam(c::le);
        /*constexpr*/ inline auto ge    = detail::simpleTypeParam(c::ge);
        /*constexpr*/ inline auto eq    = detail::simpleTypeParam(c::eq);
        /*constexpr*/ inline auto ne    = detail::simpleTypeParam(c::ne);
        /*constexpr*/ inline auto lnot  = detail::typeParam<type::Bool>(c::lnot);
        /*constexpr*/ inline auto land  = detail::typeParam<type::Bool>(c::land);
        /*constexpr*/ inline auto lor   = detail::typeParam<type::Bool>(c::lor);
