...
// TODO: Decide where to use std::size_t and where to use Integral
...
namespace cynth {
    ...
    namespace def {
        ...
        ***/
        ...
        constexpr char const * integral = cynth::integral;
        constexpr char const * floating = cynth::floating;
    ...
    namespace c {
        ...
        \t...\t
        ***/
        std::string indentation (std::size_t n = 1);

        /***
        \t...\t<stmt>
        ***/
        std::string indented (std::string stmt, std::size_t n = 1);
        ...
        ***/
        std::string arrayBulkInitialization (
            ...
            //Integral size, std::string const & type
        );
        ...
        ***/
        std::string bufferType (Integral size);
        ...
        ***/
        ...
        <val>
        ***/
        std::string integralLiteral (Integral val);

        /***
        # Float literal
        <val>f
        ***/
        std::string floatingLiteral (Floating val);
